		...
		<div className="flex flex-col md:py-20 md:p-40 p-10 bg-[#E5E4E2]">
			...
			<div className="md:flex md:px-20 md:space-x-10 space-y-10 md:space-y-0">
				<div className="rounded-sm bg-white p-8">
					<Image src="/images/tab-1.webp" alt="Picture of the author" width={400} height={400} className="w-96" />
				...
				<div className="rounded-sm bg-white p-8">
					<Image src="/images/tab-2.webp" alt="Picture of the author" width={400} height={400} className="w-96" />
				...
				<div className="rounded-sm bg-white p-8">
					<Image src="/images/tab-3.webp" alt="Picture of the author" width={400} height={400} className="w-96" />
