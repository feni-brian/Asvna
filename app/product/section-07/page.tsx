			...
			<div className="py-20 space-y-20 px-10 items-center justify-center flex flex-col bg-[#E5E4E2]">
				...
				<div className="space-y-10 md:space-x-40 md:flex md:space-y-0">
					<div className="flex-col w-96 space-y-4 flex">
						<Image src="/images/icons/gears.png" width={300} height={300} alt="logo" className="h-20 w-20" />
					...
					<div className="flex-col w-96 space-y-4 flex">
						<Image src="/images/icons/puzzle.png" width={300} height={300} alt="logo" className="h-20 w-20" />
					...
					<div className="flex-col w-96 space-y-4 flex">
						<Image src="/images/icons/refresh-2.png" width={500} height={500} alt="logo" className="h-20 w-20" />
				...
				<div className="space-y-10 md:space-x-40 md:flex md:space-y-0">
					<div className="flex-col w-96 space-y-4 flex">
						<Image src="/images/icons/lock.png" width={300} height={300} alt="logo" className="h-20 w-20" />
					...
					<div className="flex-col w-96 space-y-4 flex">
						<Image src="/images/icons/contacts.png" width={300} height={300} alt="logo" className="h-20 w-20" />
					...
					<div className="flex-col w-96 space-y-4 flex">
						<Image src="/images/icons/menu.png" width={500} height={500} alt="logo" className="h-20 w-20" />
						...
						<div className="ml-6 space-y-4">
							...
							<div className="text-xl"> • Track all of your team&apos;s projects in a single view with Portfolios</div>
							<div className="text-xl"> • Save time on creating reports with a robust Charts template library</div>
						</div>
					</div>
				</div>
