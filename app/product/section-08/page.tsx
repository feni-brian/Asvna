		...
		<div>
			<section className="flex flex-col py-20 items-center justify-center bg-[#28282B]">
				<div className="text-center flex flex-col items-center justify-center pb-20">
					<Image src="/images/logo/logo-13.svg" alt="logo" width={100} height={100} className="w-60 h-60 mx-auto" />
					...
					<div className="text-4xl bg-white p-6 rounded-lg w-60 items-center justify-center flex cursor-pointer">Get started</div>
				</div>
				<div className="hidden md:flex pt-40 space-x-40 border-t">
					...
					<div className="flex-col space-y-6 flex">
						<div className="text-xl text-gray-200 pb-10">Workflow Solutions</div>
